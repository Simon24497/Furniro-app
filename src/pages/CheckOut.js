...
import { checkbox } from "../assets/data/data"
import { motion } from "framer-motion"

const CheckOut = ({ products, onQuantityChange, resetShoppingCart }) => {
	...
	const handleSubmit = (event) => {
		...
		// Show alert
		alert("Order confirmed! It's ready for delivery.")
	...
	return (
		<motion.div
			...
			<form
				...
				<div className="checkout-subtotal-box">
							...
							{checkbox.map((index) => (
								<div
									...
									<input
										type="checkbox"
										name="paymentMethod"
										checked={index === paymentMethod}
										onChange={() => handlePaymentMethodChange(index)}
									/>
									<label>{index.title}</label>

									<p className={index === paymentMethod ? "visible" : "hidden"}>
										{index.text}
									</p>
								</div>
							))}
